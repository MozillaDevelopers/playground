...
const Tutorial = () => (
  <div>
    ...
    <p>
      ...
      <a
        href="https://developer.mozilla.org/docs/Tools/Debugger"
        target="_blank"
    ...
    <p>
      ...
      <a
        href="https://github.com/devtools-html/debugger.html"
        target="_blank"
    ...
    <p>
      ...
      features, is blazingly fast, and comes packed with all the development tools you need to build
      for the open web.
    </p>
