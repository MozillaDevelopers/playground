(function () {
  ...
  function la(a) {
    for (var b = []; a && a.parentNode && a.parentNode.nodeType == 1;) { (a = a.parentNode), b.push(a); }
    return b;
  }
  function q(a, b, c) {
    function d(a) {
      ...
      if (h.composed && typeof a.composedPath === 'function') {
        for (var e = a.composedPath(), f = 0, F; (F = e[f]); f++) { F.nodeType == 1 && ja(F, b) && (d = F); }
      } else {
        a: {
